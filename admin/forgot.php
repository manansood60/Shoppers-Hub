...
if(isset($_POST['submit'])){
	...
	$sql='select * from tbladmin where ausername="'.$uname.'"';
  ...
  if(!(empty($row)))
  {
    ...
    // To Send Message To Email
      /*
        ...
        $message = "Your Password is ".$row['apassword'];
  ...
  <div class="login-box-body">
    ...
    <form action="#" method="post">
      ...
      <div class="form-group">
          <button type="submit" name="submit" class="btn btn-success btn-block btn-flat">Send Password</button>
      </div>
    </form>
