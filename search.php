  ...
  <div class="banner inner-banner">
    <div class="container">
      <section class="banner-detail">
        <h1 class="banner-title"><?php echo $search; ?></h1>
                ...
                <div class="shop-list-view">
                  <div class="product-item">
                    ...
                    <div class="product-image">
                     <a href="product-page.php?product='.$rowsearch['id'].'"> <img src="images/products/'.$rowsearch['productprimaryimage'].'" alt="'.$rowsearch['producttitle'].'"> </a>
                    </div>
                  </div>
                  <div class="product-item-details">
                    <div class="product-item-name"> 
                      <a href="product-page.php?product='.$rowsearch['id'].'">
                      '.$rowsearch['producttitle'].'</a>
                    </div>
                    <div class="rating-summary-block">
                      <div title="53%" class="rating-result"> <span style="width:53%"></span> </div>
                    </div>
                    <div class="price-box"> 
                      <span class="price fa fa-rupee">'.$rowsearch['productofferprice'].'</span> <del class="price old-price fa fa-rupee">'.$rowsearch['productprice'].'</del>
                    </div>
                    <p style="max-height:11ch; overflow:hidden;">'.$rowsearch['productdescription'].'</p>
                    <div class="bottom-detail">
                      <ul>
                        <li>
                            <a href="product-page.php?product='.$rowsearch['id'].'"><button class="btn-black"><i class="fa fa-eye"></i> View Product</button></a>
                        </li>
                      </ul>
                    </div>
                  </div>
              ...
              <div class="col-xs-12">
                <div class="pagination-bar">
                  <ul>
                    ...
                    if($thispage>1){
                      $temppage=$thispage-1;
                      echo 'search.php?search='.$search.'&page='.$thispage.'&showpage='.$results_per_page;
                    }
                    ...
                    // For Pagination
                      for($page=1;$page<=$number_of_pages;$page++){
                        ...
                        echo '><a href="search.php?page='.$page.'&search='.$search.'&showpage='.$results_per_page.'">'.$page.'</a></li>';
                      }
                    // For right Arrow
                      echo '<li><a href="';
                    if($thispage<$number_of_pages){
                      $temppage2=$thispage+1;
                      echo 'search.php?page='.$temppage2.'&search='.$search.'&showpage='.$results_per_page;
                    }
