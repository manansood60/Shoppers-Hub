...
$sqlevent="select * from tblevent order by id desc limit 3";
...
// For pagination 
  ...
  $sqlproduct="select * from tblproduct order by rand() limit ".$startnum.",".$results_per_page;
        ...
        <div class="main-banner">
          <?php 
            while($rowevent=mysqli_fetch_assoc($resultevent)){
              echo '
                <div class="item"><a href="#"><img src="images/events/'.$rowevent['eimage'].'" style="width:100%;" alt="'.$rowevent['etitle'].'">
      ...
      <div class="row">
        <div class="col-md-3 col-sm-4 mb-xs-30">
          <div class="sidebar-block">
            ...
            <div class="sidebar-box mb-40 visible-sm visible-md visible-lg" style="border:1px dotted red;"> <a href="todaysdeal.php"> <img  src="images/todaysdeals.png" alt="SuperStore"> </a> </div>
              ...
              <div class="col-xs-12">
                <div class="pagination-bar">
                  <ul>
                    ...
                    if($thispage>1){
                      $temppage=$thispage-1;
                      echo 'todaysdeal.php?page='.$temppage.'&showpage='.$results_per_page;
                    }
                    ...
                    // For Pagination
                      for($page=1;$page<=$number_of_pages;$page++){
                        ...
                        echo '><a href="todaysdeal.php?page='.$page.'&showpage='.$results_per_page.'">'.$page.'</a></li>';
                      }
                    // For right Arrow
                      echo '<li><a href="';
                    if($thispage<$number_of_pages){
                      $temppage2=$thispage+1;
                      echo 'todaysdeal.php?page='.$temppage2.'&showpage='.$results_per_page;
                    }
