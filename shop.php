              ...
              <div class="col-md-6">
                <div class="view">
                  ...
                  <div class="list-types list"> 
                    <a href="shop-list.php?category=<?php echo $category; ?>">
              ...
              <div class="col-xs-12">
                <div class="pagination-bar">
                  <ul>
                    ...
                    if($thispage>1){
                      $temppage=$thispage-1;
                      echo 'shop.php?page='.$temppage.'&category='.$category.'&showpage='.$results_per_page;
                    }
                    ...
                    // For Pagination
                      for($page=1;$page<=$number_of_pages;$page++){
                        ...
                        echo '><a href="shop.php?page='.$page.'&category='.$category.'&showpage='.$results_per_page.'">'.$page.'</a></li>';
                      }
                    // For right Arrow
                      echo '<li><a href="';
                    if($thispage<$number_of_pages){
                      $temppage2=$thispage+1;
                      echo 'shop.php?page='.$temppage2.'&category='.$category.'&showpage='.$results_per_page;
                    }
